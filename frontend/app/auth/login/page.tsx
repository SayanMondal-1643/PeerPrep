      ...
      <Card className="w-full max-w-md border-border">
        <div className="p-8">
          ...
          <div className="mt-8 p-4 rounded-md bg-card border border-border space-y-1">
            ...
            <p className="text-xs text-muted-foreground">Admin: admin@example.com (any password)</p>
            <p className="text-xs text-muted-foreground">Teacher: teacher@example.com (any password)</p>
            <p className="text-xs text-muted-foreground">Student 1: sayan@example.com (any password)</p>
            <p className="text-xs text-muted-foreground">Student 2: subhajit@example.com (any password)</p>
          </div>
        </div>
      </Card>
    </div>
